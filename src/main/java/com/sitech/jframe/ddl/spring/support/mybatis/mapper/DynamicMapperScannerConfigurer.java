...
/**
 * 将 ClassPathMapperScanner 替换为 DynamicClassPathMapperScanner
 * @author zhangsf
 *
 */
public class DynamicMapperScannerConfigurer implements
	...
	public void postProcessBeanDefinitionRegistry(
		...
		DynamicClassPathMapperScanner scanner = new DynamicClassPathMapperScanner(registry);
